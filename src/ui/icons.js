...
export const icons = {
  ...
  color: svg('<path class="we-color-bar" d="M4 20h16"/><path d="M7 16 12 4l5 12"/><path d="M8.5 12h7"/>'),
  bgColor: svg('<path d="M10 12l6-6 3 3-6 6z"/><path d="M10 12l-3.5 2.5L9 17l4-2"/><path class="we-color-bar" d="M4 20h16"/>'),
  ...
  // 수식: 근호(√) + 피개식 x.
  formula: svg('<polyline points="3 13 5.5 13 8.5 19.5 12 4.5 21 4.5"/><line x1="13.5" y1="10.5" x2="19" y2="16.5"/><line x1="19" y1="10.5" x2="13.5" y2="16.5"/>'),
